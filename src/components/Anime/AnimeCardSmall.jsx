  ...
  return (
    <Link to={`/animes/${anime._id}`}>
      ...
      >
        ...
        <div className="group-hover:invisible pt-2 px-2">
        ...
        <div className="hidden group-hover:block absolute top-0 w-full h-full bg-[rgba(33,33,33,0.8)] font-[Lato] p-2 space-y-1 md:space-y-2">
